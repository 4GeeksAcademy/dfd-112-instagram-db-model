...
Revision ID: 923330fba4a0
Revises: a5cffa318ac2
Create Date: 2025-07-31 16:00:25.444178
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('type', sa.Enum('IMAGE', 'VIDEO', 'PENDING', name='super_enum'), nullable=False),
